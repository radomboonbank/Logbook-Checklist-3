...
with st.form("log_form"):
    ...
    employee = st.selectbox("👨‍💻 ชื่อ ผู้ตรวจสอบ", [
        "นายระดมบุญ ทักษณา",
        "นายฉัตรชัย ดำคำ",
        "นายจักรี พันธุ์เขียน",
        "นายเจตน์ บุญญดิเรก",
        "นายทรงศักดิ์ วนานุกัณฑ์",
        "นายสิริพงษ์ สินจินา",
        "นายนิวัฒน์ เก่งกล้า",
        "นายธีรักชาติ ขำสาย",
        "นายเสน่ห์ กองรส",
        "นายลาภชนก ทิมสถิตย์",
        "นายสิทธิพงษ์ หลงเจริญ",
        "นายภาคภูมิ นิลธกิจ",
        "นายอานุภาพ พฤกษาวาณิชย์",
        "นายนพนัฐ มิตรสมาน",
        "นายสรพล อึ๊งอาภรณ์",
        "นายธนกร ทิพย์เที่ยงแท้"
    ])
    receiver = st.selectbox("👷 ชื่อ ผู้รับเวร", [
        "นายระดมบุญ ทักษณา",
        "นายฉัตรชัย ดำคำ",
        "นายจักรี พันธุ์เขียน",
        "นายเจตน์ บุญญดิเรก",
    ...
    shift = st.selectbox("⏱️ ช่วงเวลาตลอดสอบ", ["ตรวจกะ 00.00 - 08.00 น.", "ตรวจกะ 08.00 - 16.00 น.", "ตรวจกะ 16.00 - 24.00 น."])
    department = st.selectbox("🏢 ข้อมูลแผนกที่ตรวจสอบ", ["แผนก หถก1,2", "แผนก หถก3,4", "แผนก หถก5,6"])
